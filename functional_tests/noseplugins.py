# Forked from the nose multiprocess plugin
...
class DjangoMultiProcess(Plugin):
    """
    ...
    def options(self, parser, env):
        ...
        """
        parser.add_option("--django-processes", action="store",
                          ...
                          "[NOSE_PROCESSES]")
        parser.add_option("--django-process-timeout", action="store",
        ...
        parser.add_option("--django-process-restartworker", action="store_true",
